...
//@Configuration
//@Order(10)
//@ImportResource({"/META-INF/spring/integration/jms/common.xml","/META-INF/spring/integration/jms/inboundChannelAdapter.xml","/META-INF/spring/integration/jms/outboundChannelAdapter.xml"})
public class JmsCommandChannelAdapter extends UtilCommand implements CommandLineRunner {
    @Override
